...
def test_read_geomet_1file_string():
    ...
    np.testing.assert_almost_equal( data_geomet["var"][0,0:4] , [ 0.09765625, 0.0625, 0.09375, 0.1015625 ] )
...
def test_read_geomet_1file_list():
...
def test_read_geomet_4files_list():
