...
def plot_data(var=None,lat=None,lon=None,date=None,png=True,gif=False,legend=False,cities=True,basefilename='/tmp/test',silent=True):
    """
        ...
        >>> # plot (2 time steps)
        >>> plot_geomet = plot_data(var=data_geomet["var"],lat=data_geomet["lat"],lon=data_geomet["lon"],date=dates,png=True,gif=True,legend=True,cities=True,basefilename='/tmp/test_4dates',silent=True)
        ...
        >>> # plot (1 time step)
        >>> plot_geomet = plot_data(var=data_geomet["var"][0],lat=data_geomet["lat"],lon=data_geomet["lon"],date=dates[0],png=True,gif=False,legend=False,cities=True,basefilename='/tmp/test_1date',silent=True)
        >>> print("All PNG files created: ", plot_geomet['png'])
        ...
        >>> plot_caspar = plot_data( var=data_caspar["var"], lat=data_caspar["lat"], lon=data_caspar["lon"], date=dates, png=True, gif=True, legend=True, cities=True, basefilename='/tmp/test_2dates_caspar', silent=True)
