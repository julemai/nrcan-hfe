...
\begin{tabular}{L{1cm}L{3cm}R{3cm}R{3cm}R{3cm}}
	...
	\hline
	\multicolumn{2}{l}{historical\_flood.json} & 1999 & 1949$^\mathrm{a}$ & 1949$^\mathrm{c}$ \\
	\multicolumn{2}{l}{historical\_flood\_event.json} & 376 & 363$^\mathrm{b}$ & 363$^\mathrm{c}$\\
	\hline
	...
	\multicolumn{1}{r}{$^\mathrm{b}$ $\ldots$} & \multicolumn{4}{l}{in total, n=14 features are flagged; }\\
