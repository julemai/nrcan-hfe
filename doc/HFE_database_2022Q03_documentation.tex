...
\begin{figure}[h]
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[height=0.58\linewidth]{figures/test-map-geomet-geo-weather_2022082412.png}
		\hspace*{0.5cm}
		\includegraphics[height=0.58\linewidth]{figures/test-map-geomet-geo-weather_legend.png}
		\caption{Raw PNG and legend for RDPA data retrieved using \url{https://geo.weather.gc.ca}\\(only displayed for reference)}
		\label{fig:plot_example:geo-weather}
	\end{subfigure}
	\hspace*{0.05\textwidth}
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[height=0.58\linewidth]{figures/test-map-geomet-nrcan-hfe_2022082412.png}
		\hspace*{0.5cm}
		\includegraphics[height=0.58\linewidth]{figures/test-map-geomet-nrcan-hfe_legend.png}
		\caption{PNG and legend produced using NRCan-HFE library based on GRIB2 data (RDPA) retrieved using \url{https://api.weather.gc.ca/}}
...
\begin{figure}[h]
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\includegraphics[height=0.58\linewidth]{figures/test-map-geomet-nrcan-hfe_legend.png}
		\caption{PNG and legend produced using NRCan-HFE library based on GRIB2 data (RDPA) retrieved using \url{https://api.weather.gc.ca/}}
		\label{fig:plot_example:api-weather:2nd}
	\end{subfigure}
	\hspace*{0.05\textwidth}
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[height=0.58\linewidth]{figures/test-map-caspar-nrcan-hfe_1980011418.png}
		\hspace*{0.5cm}
		\includegraphics[height=0.58\linewidth]{figures/test-map-caspar-nrcan-hfe_legend.png}
		\caption{PNG and legend produced using NRCan-HFE library based on NetCDF data (RDRS v2.1) retrieved using \url{https://caspar-data.ca}}
		\label{fig:plot_example:caspar}
	\end{subfigure}
	\caption{RDPA (24h total precipitation) from Geomet and RDRS\_v2.1\_A\_PR0\_SFC (1h accumulations) from CaSPAr for two different days (since no overlap between Geomet RDPA and CaSPAr RDRS v2.1) but requested for the same bounding box around Montreal. The panel in Fig.~\ref{fig:plot_example:api-weather:2nd} is the same as panel in Fig.~\ref{fig:plot_example:api-weather}.}
